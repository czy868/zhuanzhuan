	...
	<div class="login_m">
		...
		<div class="login_boder">
			<div class="login_padding">
				<c:if test="${ empty cookie.userCode.value}">
					<label>账号</label>
					<input type="text" id="userNumber" class="txt_input txt_input2"
						onfocus="if (value ==&#39;username&#39;){value =&#39;&#39;}"
						onblur="if (value ==&#39;&#39;){value=&#39;username&#39;}"
						value="" placeholder="请输入用户名" />
					<br>
					<label>密码</label>
					<input type="password" name="textfield2" id="userpwd"
						class="txt_input"
						onfocus="if (value ==&#39;******&#39;){value =&#39;&#39;}"
						onblur="if (value ==&#39;&#39;){value=&#39;******&#39;}"
						value="" placeholder="请输入密码" />
				</c:if>
				<c:if test="${not empty cookie.userCode.value}">
					<label>账号</label>
					<input type="text" id="userNumber" class="txt_input txt_input2"
						onfocus="if (value ==&#39;username&#39;){value =&#39;&#39;}"
						onblur="if (value ==&#39;&#39;){value=&#39;username&#39;}"
						value="${cookie.userCode.value}" placeholder="请输入用户名" />
					<br>
					<label>密码</label>
					<input type="password" name="textfield2" id="userpwd"
						class="txt_input"
						onfocus="if (value ==&#39;******&#39;){value =&#39;&#39;}"
						onblur="if (value ==&#39;&#39;){value=&#39;******&#39;}"
						value="${cookie.userPassword.value}" placeholder="请输入密码" />
				</c:if>
				<div class="rem_sub">
					<label> <input type="submit" class="sub_button"
						name="button" onclick="login()" value="登录" style="opacity: 0.7;">
					</label>
				</div>
