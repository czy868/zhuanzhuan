									...
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<c:forEach items="${swlist}" var="swlist" >
													<tr>
														<th>${swlist.id}</th>
														...
														<c:if test="${swlist.status == 0}">
															<th>未完成</th>
															<th><a type="button" href="selectquebank.do?studentId=${sessionScope.studentId }&courseNumber=${swlist.courseNumber}&workid=${swlist.workid}&id=${swlist.id}">做作业</a></th>
															<th></th>
														</c:if>
													</tr>
													</c:forEach>
